...
class GroupRequest(models.Model):
    ...
    new_leader = models.ForeignKey(
        "api.Student",
        verbose_name=_("new leader"),
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
        related_name="new_leader",
    )
    old_leader = models.ForeignKey(
        "api.Student",
        verbose_name=_("old leader"),
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
    ...
    remove_student = models.ForeignKey(
        "api.Student",
        verbose_name=_("remove student"),
        on_delete=models.SET_NULL,
        blank=True,
        null=True,
...
class GuideRequest(models.Model):
    ...
    timestamp_requested = models.DateTimeField(_("requested on"), auto_now=True)
    status = models.CharField(
        _("status"), max_length=1, choices=constants.STATUS, default="P"
    )
...
class Grade(models.Model):
    ...
    student = models.ForeignKey(
        "api.Student", verbose_name=_("student"), on_delete=models.CASCADE
    )
...
class Project(models.Model):
    ...
    explanatory_field = models.TextField(_("explanatory field"), blank=True, null=True)
